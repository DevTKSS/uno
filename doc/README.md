...
* `cspell --config ./build/cSpell.json "doc/**/*.md" --no-progress` to check all the markdown files in the `doc` folder.
...
* `markdownlint --config ./build/.markdownlint.json" "doc/**/*.md"` to lint all the markdown files in the `doc` folder.
